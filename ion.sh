...
sudo tar xzf ioncube_loaders_lin_x86_64.tar.gz -C /usr/local
sudo rm -rf ioncube_loaders_lin_x86_64.tar.gz
...
if [ $(uname -m) = "aarch64" ]; then
    arch="arm64"
    wget -4 https://meowmoewnigga.lol/ioncube_loaders_lin_aarch64.tar.gz
